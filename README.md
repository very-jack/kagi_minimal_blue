...
Custom CSS Steps:
In Kagi, click on the `Settings` icon in the top-right corner, go to `Appearance`, then select `Custom CSS`. Copy [the content](./kagi_minimal_blue.css) below into the text box and apply it.
